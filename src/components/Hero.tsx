    ...
    <div className="md:max-w-[80%] px-5 md:px-0 md:space-x-10 max-w-[100vw] mx-auto  flex flex-col md:flex-row sm:w-screen sm:mt-10 relative z-50 ">
      ...
      <div className="md:max-w-[50%] w-full relative flex flex-col gap-6">
        <img
          ...
          alt=""
        />
        <h1 className=" xl:text-6xl font-clash md:text-4xl text-3xl font-bold z-20">
          {data.hero.heading}
        </h1>
        <p className="text-gray-500 z-20 font-clash">
          {data.hero.subheading}
        </p>
        <div className="flex md:gap-16 gap-6">
          <button className="xl:px-10 font-clash sm:py-2 px-6 py-2 rounded-sm bg-black text-white text-[12px] xl:text-sm transition duration-200 hover:bg-white hover:text-black border-2 border-transparent hover:border-gray-500 ">
            Get Started -&gt;
          </button>
          <div className="flex items-center justify-center font-clash gap-4 hover:cursor-pointer">
